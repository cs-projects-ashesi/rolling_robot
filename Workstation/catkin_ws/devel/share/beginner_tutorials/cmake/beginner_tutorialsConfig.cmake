...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/ash-rob-15/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/ash-rob-15/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/ash-rob-15/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ash-rob-15/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
    endif()
