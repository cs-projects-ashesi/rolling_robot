...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/ash-rob-15/catkin_ws/src/simple_navigation_goals.2)
  set(simple_navigation_goals_DEVEL_PREFIX /home/ash-rob-15/catkin_ws/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/ash-rob-15/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ash-rob-15/catkin_ws/src/simple_navigation_goals.2/${idir}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
    endif()
