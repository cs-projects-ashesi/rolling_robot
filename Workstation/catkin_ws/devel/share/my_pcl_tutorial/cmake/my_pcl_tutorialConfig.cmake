...
if("TRUE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /home/ash-rob-15/catkin_ws/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /home/ash-rob-15/catkin_ws/devel)
  ...
  set(my_pcl_tutorial_INSTALL_PREFIX /home/ash-rob-15/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ash-rob-15/catkin_ws/src/my_pcl_tutorial/${idir}'.  Ask the maintainer 'ash-rob-15 <ash-rob-15@todo.todo>' to fix it.")
    endif()
